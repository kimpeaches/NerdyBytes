...
const EditOption = ({ currentUser }) => {
  ...
  return (
    <>
      <div className="card shadow m-5 p-3 col-6 mx-auto">
        <div className="card-body">
          <form onSubmit={handleSubmit} id="update-option-form">
            <h1 className="card-title">Update a Possible Answer:</h1>
            <div className="form-floating mb-3">
              ...
              />
              <label htmlFor="possibleAnswer">Possible Answer</label>
            </div>
      ...
      <div
        className={
          optionCreated ? "alert alert-success p-2 col-6 mx-auto" : "d-none"
        }
      >
        <p className="h3 text-center">Answer Successfully Updated!</p>
        <button onClick={() => navigate(-1)} className="m-3 larger-text">
